...
<div class="py-5 text-center">
  ...
  <c:set value="${compte-virement}" var="compteVirement"/>
  
  <% Compte compte = (Compte)request.getAttribute("compte-virement"); %>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="pMontant"/><div class="invalid-feedback">
             ...
             <div class="col-md-4 mb-3">
            <label for="state">Id du compte receveur</label>
            <input type="text" name="pIdCompteRecv"/><div class="invalid-feedback">
               Veuillez renseigner le compte
            </div>
            <div>
          ...
          <div>
           ...
           <div>
            <input type="hidden" name="pClientId" value="<%= compte.getClientID() %>" /> <!-- à revoir -->
