...
<link href="assets/styles/bootstrap.min.css" rel="stylesheet" />
  ...
  <%-- ============================================================================= --%>
  <%--
  		> affichage de la liste des messeges sauvegardés dans la requête avant délégation
  ...
  <!-- formulaire d'auth° -->
  <!-- 
  		> à la soumisssion du formulaire (click sur le bouton Se connecter) :
  				-> appel de la servlet ayant l'url /authentification-servlet = envoi d'une rquête http en post (réf method="post")
  						-> url de la requête : http://localhost:8080/gestion-clients/authentification-servlet
  						-> paramètres de la requête (ref attribut name des input):
