...
<!-- ====================================================================================== -->	
	...
	<c:if test="${ empty exception}">
		<div class="table-responsive">
      	...
      	<!-- Affichage des boutons modifier et supprimer uniquement si le client appartient au conseiller enregistré -->
     <% 
	 ...
	 %>
      	...
      	<a href="gestion-compte-servlet?action=getcomptes&id-client=<%= client.getIdClient() %>" class="btn btn-success btn-sm" role="button">Voir les comptes associés</a>
      </c:if>
     ...
     <!-- -------Affichage des comptes du client recherché ----------------------- -->	
