...
<link href="assets/styles/dashboard.css" rel= "stylesheet">
  ...
  <a class="btn btn-outline-primary" href="authentification-servlet?destroy=true">Se déconnecter</a>
  </c:if>
</div>
...
<div class="container">
  <div class="card-deck mb-3 text-center">
    ...
    <form class="form-signin" method="post" action="gestion-client-servlet">
      ...
      <div class="card-body">
       ...
       <input type="hidden" name="action" value="gererClient"/>
        <button type="submit" class="btn btn-lg btn-block btn-outline-primary" >Gérer les clients</button>
   ...
   <!--   <c:set value="${compte-modif}" var="compteUpdate"/>  a vérifier -->
	 ...
	 %>
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <button type="submit" class="btn btn-lg btn-block btn-outline-primary" >Gérer les comptes</button>
             
          
    </div>
        <!--  <button type="submit" class="btn btn-lg btn-block btn-primary">Gérer les comptes</button>-->
